...
#define OPENCV_HAL_IMPL_VSX_MUL_SAT(_Tpvec, _Tpwvec)             \
    ...
    inline void
    v_mul_expand(const v_uint32x4 &a, const v_uint32x4 &b, v_uint64x2 &c, v_uint64x2 &d) {
    ...
    inline v_int16x8 v_mul_hi(const v_int16x8 &a, const v_int16x8 &b) {
        ...
        static const vec_uchar16 perm = {2, 3, 18, 19, 6, 7, 22, 23, 10, 11, 26, 27, 14, 15, 30,
                                         31};
...
////////// Matrix operations /////////
    ...
    inline v_float32x4 v_matmul(const v_float32x4 &v, const v_float32x4 &m0,
        ...
        return v_float32x4(vec_madd(v0, m0.val, vec_madd(v1, m1.val, vec_madd(v2, m2.val,
                                                                              vec_mul(v3,
                                                                                      m3.val)))));
    }
